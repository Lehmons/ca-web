...
export default function Logos({ logos }) {
	...
	const logoReference = [logos?.logo1, logos?.logo2, logos?.logo3, logos?.logo4, logos?.logo5, logos?.logo6, logos?.logo7, logos?.logo8, logos?.logo9, logos?.logo10, logos?.logo11, logos?.logo12, logos?.logo13 ];
